...
const SupplierDashboard: React.FC = () => {
  ...
  const menuItems = [
    ...
    { id: 'orders', label: 'Assigned Orders', icon: <OrdersIcon /> },
    { id: 'quotes', label: 'My Quotes', icon: <QuotesIcon /> },
            ...
            <Card>
              <CardContent>
                ...
                <Typography color="textSecondary">
                  No recent orders. Check the assigned orders tab for new requests.
                </Typography>
              </CardContent>
            </Card>
          </Box>
      ...
      >
        <Toolbar>
          <Typography variant="h6" noWrap component="div" sx={{ flexGrow: 1 }}>
            Paradigm Laboratory - Supplier Portal
          </Typography>
